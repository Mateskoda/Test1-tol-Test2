...
//        Scanner sc = new Scanner(System.in);
        ...
        while (stop == 0) {
            ...
            if (!doOrNot.equals("I")) {
                ...
                System.out.println("Eddig " + (int) hoover1.countMinutes + " percig porszívóztál,megtelt a porszívód porral. Még " + (int) hoover1.houseSqM + " egységnyi por maradt a házban");
