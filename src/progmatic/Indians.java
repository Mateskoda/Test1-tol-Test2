...
//        }
        ...
        System.out.println(cntIndiansInColective(indians, "Apache"));
        System.out.println(menContraWomenInColective(indians, "Seminole"));
        System.out.println(oldMen(indians, parts));
        System.out.println(avgEquipments(indians, parts));
        System.out.println(hasBow(parts));
        System.out.println(noMokaszins(parts, indians));

        //    Hány indián szerepel a leltárban?
//    Hány különböző eszköz szerepel a leltárban?
//    Hányan vannak egy adott indián törzsben?
//    (A metódus bemeneti paraméterül kapja a törzs nevét.)
...
//    Hány mezítlábas indián van? Mennyi az átlagéletkoruk?
//    (Mezítlábas az, akinek nincs mokaszinje.)
//
...
//
        ...
        System.out.println(menContra(indians));
...
//        System.out.println(max + );
    ...
    public static HashMap<String, Double> menContra(String[][] indians) {
        ...
        for (int i = 0; i < indians.length; i++) {
            if (menContra.containsKey(indians[i][1])) {
                ...
                menContra.put(indians[i][1], menContraWomenInColective(indians, indians[i][1]));
            }
        }
        return menContra;
    }
    ...
    public static double menContraWomenInColective(String[][] indians, String collective) {
        int cntM = 0;
        int cntW = 0;
        for (int i = 0; i < indians.length; i++) {
            if (indians[i][1].equals(collective) && indians[i][2].equals("f")) {
