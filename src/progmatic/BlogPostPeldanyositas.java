...
public class BlogPostPeldanyositas {
    public static void main(String[] args) {
        BlogPost firstBlog = new BlogPost("Lorem Ipsum","Gipsz Jakab", "2000.05.04.","Lorem ipsum dolor sit amet.") ;
        BlogPost secondBlog = new BlogPost("Wait but why" ,"Tim Urban posztolva", "2010.10.10.","A popular long-form, stick-figure-illustrated blog about almost everything.");
